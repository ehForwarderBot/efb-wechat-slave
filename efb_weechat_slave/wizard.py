...
class DataModel:
    ...
    def __init__(self, profile: str, instance_id: str):
        ...
        self.channel_id = WeechatChannel.channel_id
        if instance_id:
    ...
    def build_default_config(self):
        s = _(
            ...
            "# ===========================================\n"
            "# EFB Weechat Slave Channel Configuration File\n"
            "# ===========================================\n"
            "#\n"
...
flags_settings = {
    ...
    "on_log_out":
        ("idle", 'choices', ['idle', 'reauth', 'command'],
         _('Behavior when Weechat server logged your account out.\n'
           '\n'
           'Options:\n'
    ...
    "send_stickers_and_gif_as_jpeg":
        (False, 'bool', None,
         _('Send stickers and GIF images as JPEG to bypass Web Weechat custom '
           'sticker limits as a workaround.'
           )),
    "system_chats_to_include":
        (["filehelper"], 'multiple', ['filehelper', 'fmessage', 'newsapp', 'waysheen'],
         _(
             ...
             '(OneDollar News) and, waysheen (Weechat Team).'
        )),
    "user_agent":
        (None, 'str', None,
         _('Choose the User Agent string to use when accessing Web Weechat. '
...
def wizard(profile, instance_id):
    ...
    print_wrapped(_(
        "=====================================\n"
        "EFB Weechat Slave Channel Setup Wizard\n"
        "=====================================\n"
    ))
    ...
    print()
    print_wrapped(_(
        "Congratulations! You have finished the setup wizard for EFB Weechat "
        "Slave channel."
    ))
